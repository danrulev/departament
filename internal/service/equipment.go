...
type EquipmentRepo interface {
	...
	GetByInventoryNumber(ctx context.Context, invNumber string) (*models.Equipment, error)
	List(ctx context.Context, f models.EquipmentFilter) ([]models.Equipment, int64, error)
	ListExpiredVerification(ctx context.Context, limit, offset int64) ([]models.Equipment, int64, error)
...
func (s *EquipmentService) Create(ctx context.Context, e *models.Equipment) error {
	if e.Name == "" {
...
func (s *EquipmentService) GetByID(ctx context.Context, id int64) (*models.Equipment, error) {
...
func (s *EquipmentService) List(ctx context.Context, f models.EquipmentFilter) (models.ListEquipment, error) {
	...
	if err != nil {
		return models.ListEquipment{}, fmt.Errorf("list equipment: %w", err)
	}
	return models.ListEquipment{
...
func (s *EquipmentService) ListExpiredVerification(ctx context.Context, limit, offset int64) (models.ListEquipment, error) {
	items, total, err := s.repo.ListExpiredVerification(ctx, limit, offset)
	if err != nil {
		return models.ListEquipment{}, fmt.Errorf("list expired verification: %w", err)
	}
	return models.ListEquipment{
